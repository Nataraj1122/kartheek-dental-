        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="bg-surface-container-low rounded-3xl overflow-hidden shadow-lg border border-outline-variant/30 group">
            <div className="h-80 bg-surface-container-high overflow-hidden">
               <img src="https://images.unsplash.com/photo-1612349317150-e410f624c427?q=80&w=2070&auto=format&fit=crop" alt="Dr. Kartheek" className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="p-8">
          ...
          <div className="bg-surface-container-low rounded-3xl overflow-hidden shadow-lg border border-outline-variant/30 group">
            <div className="h-80 bg-surface-container-high overflow-hidden">
               <img src="https://images.unsplash.com/photo-1594824436951-7f1262056220?q=80&w=2070&auto=format&fit=crop" alt="Dr. Sravya" className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="p-8">
